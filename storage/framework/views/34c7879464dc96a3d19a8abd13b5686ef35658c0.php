...
<div class="container text-center" style="padding: 50px 0;">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <!-- Logo Section -->
            <img src="<?php echo e(asset('img/alg.png')); ?>" alt="App Logo" 
            ...
            <!-- Button Section -->
            <a href="<?php echo e(route('tickets.create')); ?>" class="btn btn-lg" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Laravel-Support-Ticketing\resources\views/welcome.blade.php ENDPATH**/ ?>