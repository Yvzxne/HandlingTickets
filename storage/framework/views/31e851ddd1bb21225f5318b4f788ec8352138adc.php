                        ...
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm" style="background-color: var(--primary-bg); color: var(--text-color);">
                                <div class="card-body text-center">
                                    ...
                                    <div class="text-value" style="font-size: 2.5rem; font-weight: bold;"><?php echo e(number_format($totalTickets)); ?></div>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm" style="background-color: var(--secondary-bg); color: var(--text-color);">
                                <div class="card-body text-center">
                                    ...
                                    <div class="text-value" style="font-size: 2.5rem; font-weight: bold;"><?php echo e(number_format($openTickets)); ?></div>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 shadow-sm" style="background-color: var(--danger-bg); color: var(--text-color);">
                                <div class="card-body text-center">
                                    ...
                                    <div class="text-value" style="font-size: 2.5rem; font-weight: bold;"><?php echo e(number_format($closedTickets)); ?></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pc\Laravel-Support-Ticketing\resources\views/home.blade.php ENDPATH**/ ?>